              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Sign in to book your slot', style: TextStyle(color: color.secondary, fontSize: 15)),
                    ...
                    AppButton(
                      label: 'Sign In',
                      isLoading: isLoading,
                      onTap: () => context.read<AuthCubit>().signIn(_emailCtrl.text, _passCtrl.text),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => Navigator.pushReplacementNamed(context, AppRoutes.signUpScreen),
                          child: Text(
                            'Sign Up',
